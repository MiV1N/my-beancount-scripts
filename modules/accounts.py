...
descriptions = {
    ...
    # 医院相关（优先匹配，避免被停车规则误匹配）
    '西南医院.*停车|医院.*停车': 'Expenses:Health:MedicalExpenses',
    ...
    # 新增餐饮
    '大米先生': 'Expenses:Food',
    '重庆益嘉星球美食空间站': 'Expenses:Food',
    '渝中区还山冰淇淋店|还山冰淇淋': 'Expenses:Food:Beverages',
    ...
    # 新增停车相关
    '重庆高科集团有限公司|重庆爱加两江星悦荟|门牌1|重庆城投金卡': 'Expenses:Transportation:Car',
    '深圳市顺易通信息科技有限公司|顺易通': 'Expenses:Transportation:Car',
    # 新增交通平台
    '北京鸿易博': 'Expenses:Transportation:PublicTransportation',
    ...
    # 新增个人转账
    '杨胜元': 'Expenses:Miscellaneous:Transfer:Yangping',
    '亲属卡交易.*瑶': 'Expenses:Miscellaneous:Transfer:Heyao',
    '喜剧小小何\\(何瑶\\)': 'Expenses:Miscellaneous:Transfer:Heyao',
    ...
    '银联在线支付|银联快捷支付|银联云闪付': 'Expenses:Unknown',
    '抖音支付科技有限公司|抖音支付-抖店|抖音支付-抖音电商': 'Expenses:Unknown',
    '传奇': 'Expenses:Miscellaneous:Unknown',
    '网银在线': 'Expenses:Unknown',
    '京东支付': 'Expenses:Unknown',
...
incomes = {
    ...
    # 退款优先（最高优先级，避免被亲情卡等规则误匹配）
    '退款|退货':'Income:Miscellaneous:Refund',
    '退款.*亲情卡|亲情卡.*退款': 'Income:Miscellaneous:Refund',
    ...
    # 新增报销相关
    '重庆紫光华山智安科技有限公司.*报销|代发工资': 'Income:Miscellaneous:Reimbursement:UNISINSIGHT',
    ...
    # 新增红包奖励
    '打开拼多多|多多视频.*点击': 'Income:Miscellaneous:Gifts:RedBag',
    '恩泽': 'Income:Miscellaneous:Gifts:RedBag',

    '建信人寿保险':'Income:Health:Insurance', #保险赔偿
    # 新增保险理赔
    '保险理赔.*太平洋人寿|汇入汇款.*太平洋人寿': 'Income:Health:Insurance',

    '(汇入汇款|转入).*何瑶':'Income:Miscellaneous:Heyao',
    '汇入汇款.*杨平':'Income:Miscellaneous:Yangping',
    '汇入汇款.*唐大秀':'Income:Miscellaneous:Tangdaxiu',
    # 新增个人转账
    '杨胜元.*汇入汇款|汇入汇款.*杨胜元': 'Income:Miscellaneous:Yangping',
    '朱鹏飞': 'Income:Miscellaneous:Unknown',

    # 新增其他收入
    'EBPR|其他.*EBPR': 'Income:Unknown',
